...
export default {
  ...
  setup(){
    ...
    const editData = async (data) => {
      ...
      const response = await store_community.editData(infoEdit)
      ...
      let index = store_community.data.findIndex(obj => obj.id === response.data.id)
      store_community.data[index] = data_for_table
      onDialogOK()
    }
